...
public class EstudianteServices {
     ...
     * @return
     */
    public List<Estudiante> listaEstudiantes() throws SQLException {
     ...
     * @return
     */
    public Estudiante getEstudiante(int matricula) throws SQLException {
     ...
     * @return
     */
    public boolean crearEstudiante(Estudiante est) throws SQLException {
    ...
    public boolean borrarEstudiante(int matricula) throws SQLException {
